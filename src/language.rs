    ...
    fn from_raw(language: PrimaryLanguage, raw: u16) -> SubLanguage {
        match language {
            ...
            PrimaryLanguage::Dutch => match raw & SUB_LANGUAGE_MASK {
                0x0400 => SubLanguage::Nsophylands,
...
mod test {
    ...
    const DUTCH_NSOPHYLANDS:          u16 = 0x0413;
    ...
    #[test]
    fn it_recognizes_dutch_from_nsophylands_as_dutch_language() {
        assert_eq!(super::from_lang_id(DUTCH_NSOPHYLANDS).primary_language(), PrimaryLanguage::Dutch);
    }

    #[test]
    fn it_recognizes_dutch_from_nsophylands_as_nsophylands_sub_language() {
        assert_eq!(super::from_lang_id(DUTCH_NSOPHYLANDS).sub_language(), SubLanguage::Nsophylands);
    }
